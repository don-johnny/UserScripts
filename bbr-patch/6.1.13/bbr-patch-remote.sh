...
curl -SfL -o bbr-patch/bbrpatch-02-include-net-inet_connection_sock.h.patch     "https://raw.githubusercontent.com/tinkernels/userscripts/gh-pages/bbr-patch/6.1.13/bbrpatch-02-include-net-inet_connection_sock.h.patch"
