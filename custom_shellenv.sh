...
curl -sSfLo "$HOME/.tmux.conf" "https://raw.githubusercontent.com/tinkernels/userscripts/gh-pages/_tmux.conf"

if [ ! -d "$HOME/.oh-my-zsh" ];then
    curl -sSfL "https://raw.githubusercontent.com/ohmyzsh/ohmyzsh/master/tools/install.sh" | bash -s
fi

curl -sSfLo "$HOME/.profile" "https://raw.githubusercontent.com/tinkernels/userscripts/gh-pages/_shellprofile"
(cd "$HOME" && ln -sf .profile .zprofile && ln -sf .profile .bash_profile)

curl -sSfLo "$HOME/.shellrc" "https://raw.githubusercontent.com/tinkernels/userscripts/gh-pages/_shellrc"
